...
pub mod person {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_phones(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::client::test_capnp::person::phone_number::Owned>> {
    ...
    #[inline]
    pub fn get_employment(self) -> crate::client::test_capnp::person::employment::Reader<'a> {
      self.reader.into()
    }
  }
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_phones(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::client::test_capnp::person::phone_number::Owned>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_phones(&mut self, value: ::capnp::struct_list::Reader<'_,crate::client::test_capnp::person::phone_number::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(2), value, false)
    }
    #[inline]
    pub fn init_phones(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::client::test_capnp::person::phone_number::Owned> {
    ...
    #[inline]
    pub fn get_employment(self) -> crate::client::test_capnp::person::employment::Builder<'a> {
      self.builder.into()
    }
    #[inline]
    pub fn init_employment(mut self, ) -> crate::client::test_capnp::person::employment::Builder<'a> {
  ...
  impl Pipeline  {
    pub fn get_employment(&self) -> crate::client::test_capnp::person::employment::Pipeline {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 95] = [
      ...
      ::capnp::word(24, 188, 232, 50, 152, 142, 128, 152),
      ::capnp::word(15, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(116, 225, 110, 248, 25, 46, 179, 158),
      ::capnp::word(4, 0, 7, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(93, 0, 0, 0, 251, 1, 0, 0),
      ...
      ::capnp::word(101, 114, 115, 111, 110, 0, 0, 0),
      ::capnp::word(4, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(208, 138, 158, 156, 178, 144, 78, 129),
      ::capnp::word(1, 0, 0, 0, 98, 0, 0, 0),
      ::capnp::word(80, 104, 111, 110, 101, 78, 117, 109),
      ...
      ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(61, 105, 195, 189, 212, 43, 11, 187),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(112, 104, 111, 110, 101, 115, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(101, 109, 112, 108, 111, 121, 109, 101),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        ...
        3 => <::capnp::struct_list::Owned<crate::client::test_capnp::person::phone_number::Owned> as ::capnp::introspect::Introspect>::introspect(),
        4 => <crate::client::test_capnp::person::employment::Owned as ::capnp::introspect::Introspect>::introspect(),
    ...
    pub const TYPE_ID: u64 = 0x9880_8e98_32e8_bc18;
  }
  ...
  pub mod phone_number {
    ...
    impl <'a,> Reader<'a,>  {
      ...
      #[inline]
      pub fn get_type(self) -> ::core::result::Result<crate::client::test_capnp::person::phone_number::Type,::capnp::NotInSchema> {
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn set_number(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
        ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false).unwrap()
      }
      #[inline]
      ...
      #[inline]
      pub fn set_type(&mut self, value: crate::client::test_capnp::person::phone_number::Type)  {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 53] = [
        ...
        ::capnp::word(115, 114, 99, 47, 116, 101, 115, 116),
        ::capnp::word(46, 99, 97, 112, 110, 112, 58, 80),
        ::capnp::word(101, 114, 115, 111, 110, 46, 80, 104),
        ::capnp::word(111, 110, 101, 78, 117, 109, 98, 101),
        ::capnp::word(114, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(4, 0, 0, 0, 1, 0, 1, 0),
        ::capnp::word(47, 6, 133, 213, 4, 189, 224, 145),
      ...
      pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
        match index {
          ...
          1 => <crate::client::test_capnp::person::phone_number::Type as ::capnp::introspect::Introspect>::introspect(),
          _ => panic!("invalid field index {}", index),
        }
      }
      pub fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
      ...
      pub const TYPE_ID: u64 = 0x814e_90b2_9c9e_8ad0;
    }
    ...
    impl ::core::convert::TryFrom<u16> for Type {
      ...
      fn try_from(value: u16) -> ::core::result::Result<Self, <Type as ::core::convert::TryFrom<u16>>::Error> {
        match value {
          0 => ::core::result::Result::Ok(Self::Mobile),
          1 => ::core::result::Result::Ok(Self::Home),
          2 => ::core::result::Result::Ok(Self::Work),
    ...
    impl ::capnp::traits::HasTypeId for Type {
      const TYPE_ID: u64 = 0x91e0_bd04_d585_062fu64;
    }
    mod type_ {
    pub static ENCODED_NODE: [::capnp::Word; 32] = [
      ...
      ::capnp::word(101, 114, 115, 111, 110, 46, 80, 104),
      ::capnp::word(111, 110, 101, 78, 117, 109, 98, 101),
      ::capnp::word(114, 46, 84, 121, 112, 101, 0, 0),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(109, 111, 98, 105, 108, 101, 0, 0),
  ...
  pub mod employment {
    ...
    impl <'a,> Reader<'a,>  {
      ...
      pub fn which(self) -> ::core::result::Result<WhichReader<'a,>, ::capnp::NotInSchema> {
        match self.reader.get_data_field::<u16>(2) {
          0 => {
            ::core::result::Result::Ok(Unemployed(
              ()
            ))
          }
          1 => {
            ::core::result::Result::Ok(Employer(
              ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(3), ::core::option::Option::None)
            ))
          }
          2 => {
            ::core::result::Result::Ok(School(
              ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(3), ::core::option::Option::None)
            ))
          }
          3 => {
            ::core::result::Result::Ok(SelfEmployed(
              ()
            ))
          }
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn set_employer(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
      ...
      #[inline]
      pub fn set_school(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 82] = [
        ...
        ::capnp::word(115, 114, 99, 47, 116, 101, 115, 116),
        ::capnp::word(46, 99, 97, 112, 110, 112, 58, 80),
        ::capnp::word(101, 114, 115, 111, 110, 46, 101, 109),
        ::capnp::word(112, 108, 111, 121, 109, 101, 110, 116),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ...
        ::capnp::word(117, 110, 101, 109, 112, 108, 111, 121),
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(101, 109, 112, 108, 111, 121, 101, 114),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(12, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(115, 99, 104, 111, 111, 108, 0, 0),
        ::capnp::word(12, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(115, 101, 108, 102, 69, 109, 112, 108),
        ::capnp::word(111, 121, 101, 100, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      pub const TYPE_ID: u64 = 0xbb0b_2bd4_bdc3_693d;
    }
...
pub mod address_book {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_people(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::client::test_capnp::person::Owned>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_people(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::client::test_capnp::person::Owned>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_people(&mut self, value: ::capnp::struct_list::Reader<'_,crate::client::test_capnp::person::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
    }
    #[inline]
    pub fn init_people(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::client::test_capnp::person::Owned> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 38] = [
      ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
      ::capnp::word(52, 161, 168, 84, 179, 217, 52, 249),
      ::capnp::word(15, 0, 0, 0, 1, 0, 0, 0),
      ::capnp::word(116, 225, 110, 248, 25, 46, 179, 158),
      ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(253, 1, 0, 0, 46, 2, 0, 0),
      ...
      ::capnp::word(100, 100, 114, 101, 115, 115, 66, 111),
      ...
      ::capnp::word(112, 101, 111, 112, 108, 101, 0, 0),
      ::capnp::word(14, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 3, 0, 1, 0),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        0 => <::capnp::struct_list::Owned<crate::client::test_capnp::person::Owned> as ::capnp::introspect::Introspect>::introspect(),
        _ => panic!("invalid field index {}", index),
      }
    }
    pub fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
    ...
    pub const TYPE_ID: u64 = 0xf934_d9b3_54a8_a134;
  }
}
