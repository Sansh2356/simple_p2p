...
pub mod person {
    ...
    impl<'a> Reader<'a> {
        ...
        pub fn get_phones(
            ...
            ::capnp::struct_list::Reader<
                'a,
                crate::client::test_capnp::person::phone_number::Owned,
            >,
        > {
            ::capnp::traits::FromPointerReader::get_from_pointer(
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn init_phones(
            self,
            size: u32,
        ) -> ::capnp::struct_list::Builder<'a, crate::client::test_capnp::person::phone_number::Owned>
        {
        ...
        #[inline]
        pub fn init_employment(
            mut self,
        ) -> crate::client::test_capnp::person::employment::Builder<'a> {
    ...
    pub mod phone_number {
        ...
        impl<'a> Reader<'a> {
            ...
            pub fn get_type(
                ...
                crate::client::test_capnp::person::phone_number::Type,
                ::capnp::NotInSchema,
            > {
        ...
        impl<'a> Builder<'a> {
            ...
            pub fn set_type(
                &mut self,
                value: crate::client::test_capnp::person::phone_number::Type,
            ) {
    ...
    pub mod employment {
        pub use self::Which::{Employer, School, SelfEmployed, Unemployed};
        ...
        impl<'a> Reader<'a> {
            ...
            pub fn which(self) -> ::core::result::Result<WhichReader<'a>, ::capnp::NotInSchema> {
                match self.reader.get_data_field::<u16>(2) {
                    0 => ::core::result::Result::Ok(Unemployed(())),
                    1 => ::core::result::Result::Ok(Employer(
                        ::capnp::traits::FromPointerReader::get_from_pointer(
                            &self.reader.get_pointer_field(3),
                            ::core::option::Option::None,
                        ),
                    )),
                    2 => ::core::result::Result::Ok(School(
                        ::capnp::traits::FromPointerReader::get_from_pointer(
                            &self.reader.get_pointer_field(3),
                            ::core::option::Option::None,
                        ),
                    )),
                    3 => ::core::result::Result::Ok(SelfEmployed(())),
...
pub mod address_book {
    ...
    impl<'a> Reader<'a> {
        ...
        pub fn get_people(
            ...
            ::capnp::struct_list::Reader<'a, crate::client::test_capnp::person::Owned>,
        > {
            ::capnp::traits::FromPointerReader::get_from_pointer(
                &self.reader.get_pointer_field(0),
                ::core::option::Option::None,
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn get_people(
            ...
            ::capnp::struct_list::Builder<'a, crate::client::test_capnp::person::Owned>,
        > {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(
                self.builder.get_pointer_field(0),
                ::core::option::Option::None,
        ...
        pub fn set_people(
            &mut self,
            value: ::capnp::struct_list::Reader<'_, crate::client::test_capnp::person::Owned>,
        ) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(
                self.builder.reborrow().get_pointer_field(0),
                value,
